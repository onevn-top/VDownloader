export default {
  ...
  'about': 'À Propos de VDownloader',
  'preferences': 'Préférences...',
  'check-for-updates': 'Vérifier les mises à jour...',
  'check-updates-now': 'Vérifier maintenant',
  'checking-for-updates': 'Vérification des mises à jour ...',
  'check-for-updates-title': 'Vérifier les mises à jour',
  'update-available-message': 'Une nouvelle version de VDownloader est disponible, mise à jour maintenant?',
  ...
  'hide': 'Cacher VDownloader',
  'hide-others': 'Cacher les autres',
  'unhide': 'Tout montrer',
  'show': 'Montrer VDownloader',
  'quit': 'Quitter VDownloader',
