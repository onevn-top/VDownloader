export default {
  ...
  'update-available-message': 'Hay una nueva versión de VDownloader, ¿Actualizar ahora?',
  ...
  'unhide': 'Mostrar Todo',
  'show': 'Mostrar VDownloader',
  'quit': 'Salir de VDownloader',
