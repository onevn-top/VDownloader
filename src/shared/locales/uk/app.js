export default {
  ...
  'update-available-message': 'Нова версія VDownloader доступна для завантаження, завантажити зараз?',
  ...
  'hide': 'Сховати VDownloader',
  'hide-others': 'Сховати інше',
  'unhide': 'Відобразити все',
  'show': 'Відобразити VDownloader',
  'quit': 'Закрити VDownloader',
