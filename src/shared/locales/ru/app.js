export default {
  ...
  'update-available-message': 'Новая версия VDownloader доступна для скачивания, скачать сейчас?',
  ...
  'hide': 'Спрятать VDownloader',
  'hide-others': 'Спрятать все остальное',
  'unhide': 'Отобразить все',
  'show': 'Отобразить VDownloader',
  'quit': 'Закрыть VDownloader',
